<!-- tudo o que não estiver comentado, será codigo bootsrap. ou seja, não fui eu que escrevi 👍👍 -->


<!-- essas duas tags aqui basicamente so vao importar as bibliotecas que a gente coloca em /Lib -->
	...
	<main class="form-signin w-100 m-auto">
		<form action="login" method="post">
			...
			<div class="form-floating">
				<input value="${email}" type="email" class="form-control" id="floatingInput"
					name="email" placeholder="name@example.com"> <label
					for="floatingInput">Email address</label>
			</div>
			<div class="form-floating">
				<input value="${password}" type="password" class="form-control" id="floatingPassword"
